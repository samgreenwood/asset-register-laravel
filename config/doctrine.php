...
return [
    ...
    */
    'managers'                   => [
        'default' => [
            ...
            'mappings'      => [
                \App\Mappings\AssignmentMapping::class,
                \App\Mappings\AssetMapping::class,
    ...
    */
    'custom_types'               => [
        ...
        'node' => \App\Types\Node::class,
        'member' => \App\Types\Member::class,
        'assignable' => \App\Types\Assignable::class
    ],
    /*
    |--------------------------------------------------------------------------
